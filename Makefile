...
#-----------------------------------------------------------------------------
vendor_modify_jars := android.policy com.qti.dpmframework framework services telephony-common wifi-service dpm
...
#-----------------------------------------------------------------------------
board_modify_apps := SystemUI Telecom TeleService FlymeLauncher
...
override_property += \
    ro.flyme.romer=XXOS_Developer \
    ro.product.model_romer=HM 2_XXOS_Developer
